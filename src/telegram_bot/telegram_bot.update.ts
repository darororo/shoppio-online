...
import { Command, Ctx, Hears, Next, On, Sender, Start, Update } from 'nestjs-telegraf'
...
export class TelegramBotUpdate {
    ...
    @Start()
    async startCommand(@Ctx() ctx: Context, @UpdateType() updateType: TelegrafUpdateType, @Sender('first_name') firstName: string, @Sender('last_name') lastName: string) {
    ...
    @Command('hello')
    async helloCommand(@Ctx() ctx: Context, @UpdateType() updateType: TelegrafUpdateType, @Sender('first_name') firstName: string, @Sender('last_name') lastName: string) {
        // this.bot.start((ctx) => ctx.reply('Welcome'))
